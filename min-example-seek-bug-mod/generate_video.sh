...
gst-launch-1.0 videotestsrc num-buffers=4500 ! video/x-raw, format=BGR, width=1920, height=1080, framerate=15/1 ! videoconvert ! nvvidconv ! "video/x-raw(memory:NVMM), format=NV12" ! nvv4l2h264enc maxperf-enable=1 control-rate=0 bitrate=8000000 ! h264parse ! video/x-h264, stream-format=byte-stream ! h264parse ! matroskamux ! filesink location=video.mkv
